...
public final class FetchContextOptions {
   ...
   * call {@link #build()} to get an immutable snapshot.
   */
  public static final class Builder {
    ...
    /**
     * Sets retry-policy-related options.
     *
     * @param maxSplitfileBlockRetries maximum retries for splitfile blocks; {@code -1} means
     *     unlimited.
     * @param maxNonSplitfileRetries maximum retries for non-splitfile fetches; {@code -1} means
     *     unlimited.
     * @param maxUSKRetries maximum retries for USK updates; {@code -1} means unlimited.
     * @return this builder for chaining.
     */
    ...
    /**
     * Backward-compatible alias for {@link #retryPolicy(int, int, int)}.
     *
     * @param maxSplitfileBlockRetries maximum retries for splitfile blocks
     * @param maxNonSplitfileRetries maximum retries for non-splitfile fetches
     * @param maxUSKRetries maximum retries for USK updates
     * @return this builder for chaining
     */
    public Builder retryLimits(
        int maxSplitfileBlockRetries, int maxNonSplitfileRetries, int maxUSKRetries) {
      return retryPolicy(maxSplitfileBlockRetries, maxNonSplitfileRetries, maxUSKRetries);
    }
     ...
     *
     * @param followRedirects whether the fetcher may follow simple redirects.
     ...
     *     resolution.
     * @param canWriteClientCache whether this request may write the client cache.
     * @return this builder for chaining.
     */
    ...
    /**
     * Builds an immutable {@link FetchContextOptions} instance from the current builder state.
     *
     * @return immutable fetch-context options snapshot.
     */
