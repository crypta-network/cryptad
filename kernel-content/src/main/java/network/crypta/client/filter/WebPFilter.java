...
public class WebPFilter extends RIFFFilter {
  ...
  public WebPFilter() {
    ...
    // All per-stream states are tracked in the context created by createContext().
  }
   ...
   * callers and is passed back to later invocations of this filter while processing a single file.
   *
   * @return an opaque, mutable context object to be supplied on later callbacks and not shared
   ...
   *     are invalid; odd sizes imply one-byte padding follows
