...
public class VP8PacketFilter {
   ...
   *
   * <p>On malformed input or unsupported features, the method throws a runtime exception used by
   * the surrounding infrastructure to signal a data filtering failure. I/O failures while reading
   * from the in-memory stream surface as {@link IOException}.
   *
   * <pre>{@code
