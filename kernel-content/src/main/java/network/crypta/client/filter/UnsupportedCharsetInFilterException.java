...
/**
 * Signals that the running node does not support a character set declared or inferred during
 * client-side filtering. This exception is raised from filter components that need to interpret
