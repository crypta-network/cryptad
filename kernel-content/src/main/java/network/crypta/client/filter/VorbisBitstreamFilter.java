 ...
 * Callers typically get an instance via {@link OggBitstreamFilter#getBitstreamFilter(OggPage)}
 * after inspecting an early header page, then feed later pages to {@code parse}. The filter
