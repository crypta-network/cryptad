...
description: Draft or review GitHub release notes and changelog artifacts for Cryptad builds, including the generated Stable 1.0 RC and GA note contracts. Use when preparing an integer-build release body, updating changelog artifacts, validating Stable templates or note digests, cleaning up autogenerated draft notes, or checking release-note quality against Cryptad's integer-build release workflow.
---
