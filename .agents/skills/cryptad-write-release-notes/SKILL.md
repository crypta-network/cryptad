...
- App permission/audit changes, AppHost runtime boundary changes, developer app CLI changes,
  legacy admin retirement changes, interop gate changes, and performance-gate changes are called
  out when they affect operators, packagers, or app developers.
