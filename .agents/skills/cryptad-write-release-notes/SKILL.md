...
- App platform, Platform API, Web Shell, app bundles/catalogs, app-owned UI, and browser SDK
...
- App permission/audit changes, AppHost runtime boundary changes, legacy admin retirement changes,
  interop gate changes, and performance-gate changes are called out when they affect operators,
  packagers, or app developers.
