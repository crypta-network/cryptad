...
public abstract class LocalDirectoryToadlet extends LocalFileBrowserToadlet {
   ...
   * is safe for frequently repeated invocation across threads.
   *
   ...
   * @param persist node containing hidden fields that preserve the navigation state between
   *     requests; not modified here.
   */
  @Override
