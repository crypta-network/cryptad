 ...
 * stays outside the future browse leaf does not need to import {@link FProxyToadlet} just to group
 * routes under the historical menu headings. The values remain the original localization keys, so
 * the visible menu text, category ordering, and translation lookups continue to behave exactly as
 * they do today.
 *
