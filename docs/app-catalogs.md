...
app.site-publisher.version=3.1
app.site-publisher.summary=Publish local sites and private plain-text drafts through Crypta.
app.site-publisher.bundle.uri=https://example.invalid/apps/site-publisher-3.1.zip
...
app.site-publisher.permissions=queue.read,queue.write,content.insert,app.data.read,app.data.write,content.insert.app-document
...
app.site-publisher.permissions.rationale.app.data.read=Reads the app-owned private draft dataset.
app.site-publisher.permissions.rationale.app.data.write=Commits reviewed draft imports, edits and recovery.
app.site-publisher.permissions.rationale.content.insert.app-document=Publishes explicitly approved generated plain text at a new CHK address.
app.site-publisher.changelog.summary=Adds selected Sharesite pastebin migration and durable private drafts.
app.site-publisher.api.minimumVersion=9
app.site-publisher.api.maximumTestedVersion=24
app.site-publisher.api.targetBaseline=1.0
