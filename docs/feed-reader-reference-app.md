...
content-subscription and durable app-data surfaces introduced in v8/v9 and tested through v10.
...
| `reference-app.feed-reader-app-data` | Feed Reader declares `app.data.read` and `app.data.write`, requires at least API v9, is tested through v10, uses SDK app-data helpers, and keeps durable app-data evidence redacted. |
