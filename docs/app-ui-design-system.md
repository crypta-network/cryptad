...
Publisher, Site Publisher, and Profile Publisher Gradle `stageApp` tasks copy the same assets into
`static/crypta-ui/` during staging instead of duplicating them in `apps/*/src/staged`.
