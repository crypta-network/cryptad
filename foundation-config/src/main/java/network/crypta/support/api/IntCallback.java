 ...
 *
 * @deprecated Use {@link network.crypta.config.IntCallback}. Retained to preserve source and binary
 *     compatibility for existing {@code foundation-config} consumers.
 */
@Deprecated
