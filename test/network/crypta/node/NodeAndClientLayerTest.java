...
/**
 * Creates a node, inserts data to it, and fetches the data back. Note that we need one JUnit class per
 * node because we need to actually exit the JVM to get rid of all the node threads.
 *
 * @author toad
 */
