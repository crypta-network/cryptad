...
public class RandomAccessFileWrapperTest extends RandomAccessBufferTestBase {
    ...
    public void testStoreTo() throws IOException, StorageFormatException, ResumeFailedException {
        ...
        FileRandomAccessBuffer restored =
            (FileRandomAccessBuffer) BucketTools.restoreRAFFrom(dis, null, null, null);
    ...
    private final File base = new File("tmp.random-access-file-wrapper-test");
