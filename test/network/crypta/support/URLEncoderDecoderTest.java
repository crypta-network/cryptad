...
public class URLEncoderDecoderTest {
    ...
    /**
     * Encodes a string of ALL unicode characters except the 0-character and tests whether it is decoded
     * correctly.
     */
    @Test
    ...
    public void testEncodeDecodeString_notSafeBaseChars() {
        String[] toEncode = {
            //safe chars
            URLEncoder.safeURLCharacters, prtblAscii,
    ...
    /**
     * Tests decode(String,boolean) method using not valid hex values String to verifies if it raises an
     * exception
     */
    @Test
    ...
    /**
     * Tests decode(String,boolean) method trying the boolean argument, to verify if it work correctly as
     * a hack to allow users to paste in URLs containing %'s.
     */
    @Test
