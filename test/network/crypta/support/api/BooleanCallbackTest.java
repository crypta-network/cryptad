...
public class BooleanCallbackTest {
    ...
    @Test
    public void getGivesTheSetVariable() throws NodeNeedRestartException, InvalidConfigValueException {
        BooleanCallback callback = BooleanCallback.from(() -> theValue, (value -> {
            theValue = value;
        }));
        callback.set(true);
