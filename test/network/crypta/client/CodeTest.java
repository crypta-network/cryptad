...
public class CodeTest {
    ...
    public void testBenchmark() {
        ...
        System.out.println(
            ...
            "ms to encode()");
        System.out.println(
            "Native code took " + dNativeDecode + "ms whereas java's code took " + dPureDecode +
            "ms to decode()");
    }
    ...
    /**
     * Creates k packets of size sz of random data, encodes them, and tries to decode. Index contains the
     * permutation entry.
     */
