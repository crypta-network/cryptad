...
import network.crypta.pluginmanager.PluginStore;
...
public class PluginStoreTest {
    ...
    public void testWriteStringArrays() throws IllegalBase64Exception, FSParseException {
        ...
        assertArrayEquals(copy.stringsArrays.get(key), value);
    }
    ...
    /**
     * These are not allowed in SFS except base64 encoded when the always allow base64 flag is on. So
     * they ARE allowed in PluginStore's.
     */
    private final String invalidCharsForSFS =
        "\r\n" + SimpleFieldSet.KEYVALUE_SEPARATOR_CHAR + SimpleFieldSet.MULTI_LEVEL_CHAR +
