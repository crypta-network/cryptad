...
public class BaseL10nTest {
    ...
    public void testAddL10nSubstitution() {
        ...
        l10n.addL10nSubstitution(node, "test.substitution", new String[]{"bold"},
    ...
    public void testAddL10nSubstitutionExtra() {
        ...
        l10n.addL10nSubstitution(node, "test.substitution", new String[]{"bold", "extra"},
    ...
    public void testAddL10nSubstitutionUnclosed() {
        ...
        l10n.addL10nSubstitution(node, "test.unclosedSubstitution", new String[]{"image"},
    ...
    public void testAddL10nSubstitutionMultiple() {
        ...
        l10n.addL10nSubstitution(node, "test.multipleSubstitution", new String[]{"rep2", "rep1", "rep3"},
    ...
    public void testAddL10nSubstitutionMissing() {
        ...
        HTMLNode rep2Node = new HTMLNode("r2");
        HTMLNode rep3Node = new HTMLNode("r3");
        l10n.addL10nSubstitution(node, "test.multipleSubstitution", new String[]{"rep2", "rep3"},
    ...
    public void testAddL10nSubstitutionNested() {
        ...
        l10n.addL10nSubstitution(node, "test.nestedSubstitution", new String[]{"inner", "outer"},
    ...
    public void testAddL10nSubstitutionDouble() {
        ...
        l10n.addL10nSubstitution(node, "test.doubleSubstitution", new String[]{"tag"},
    ...
    public void testAddL10nSubstitutionSelfNested() throws Exception {
        ...
        HTMLNode node = new HTMLNode("div");
        HTMLNode tagNode = new HTMLNode("tag");
        l10n.addL10nSubstitution(node, "test.selfNestedSubstitution", new String[]{"tag"},
                                 new HTMLNode[]{tagNode});
    ...
    public void testAddL10nSubstitutionSelfNestedEmpty() {
        ...
        HTMLNode node = new HTMLNode("div");
        HTMLNode tagNode = new HTMLNode("tag");
        l10n.addL10nSubstitution(node, "test.emptySelfNestedSubstitution", new String[]{"tag"},
                                 new HTMLNode[]{tagNode});
    ...
    public void testAddL10nSubstitutionMissingBrace() {
        ...
        l10n.addL10nSubstitution(node, "test.missingBraceSubstitution", new String[]{"ok"},
                                 new HTMLNode[]{okNode});
    ...
    public void testAddL10nSubstitutionUnmatchedClose() {
        ...
        HTMLNode node = new HTMLNode("div");
        HTMLNode okNode = new HTMLNode("ok");
        l10n.addL10nSubstitution(node, "test.unmatchedCloseSubstitution", new String[]{"ok"},
                                 new HTMLNode[]{okNode});
    ...
    public void testAddL10nSubstitutionFallback() {
        ...
        HTMLNode node = new HTMLNode("div");
        HTMLNode tagNode = new HTMLNode("tag");
        l10n.addL10nSubstitution(node, "test.badSubstitutionFallback", new String[]{"tag"},
                                 new HTMLNode[]{tagNode});
