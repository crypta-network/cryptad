 ...
 * in {@code network.crypta.clients.fcp.bridge} under {@code :bridge-fcp-runtime}. Higher-level
 * runtime code should therefore depend on this endpoint-handle seam rather than on concrete FCP
 * server types.
 */
