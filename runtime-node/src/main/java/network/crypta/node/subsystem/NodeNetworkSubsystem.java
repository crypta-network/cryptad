...
public final class NodeNetworkSubsystem {
  ...
  private volatile int maxOpennetPeers;
  private volatile boolean acceptSeedConnections;
  private volatile boolean isAllowedToConnectToSeednodes;
  private volatile boolean passOpennetRefsThroughDarknet;
  private volatile boolean throttleLocalData;
  private volatile int outputBandwidthLimit;
  private volatile int inputBandwidthLimit;
