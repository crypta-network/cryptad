...
/**
 * Bridge adapter that exposes FCP persistent requests through the client-owned catalog seam.
 *
 * <p>This adapter keeps durable-request enumeration and duplicate detection inside the FCP bridge
