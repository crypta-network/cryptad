...
abstract class Logger {
    ...
    companion object {
        @Deprecated("use LogLevel constants")
        @JvmField
        val ERROR: Int = LogLevel.ERROR.ordinal

        @Deprecated("use LogLevel constants")
        @JvmField
        val WARNING: Int = LogLevel.WARNING.ordinal

        @Deprecated("use LogLevel constants")
        @JvmField
        val NORMAL: Int = LogLevel.NORMAL.ordinal

        @Deprecated("use LogLevel constants")
        @JvmField
        val MINOR: Int = LogLevel.MINOR.ordinal

        @Deprecated("use LogLevel constants")
        @JvmField
        val DEBUG: Int = LogLevel.DEBUG.ordinal

        @Deprecated("use LogLevel constants")
        @JvmField
        val INTERNAL: Int = LogLevel.NONE.ordinal
        ...
        fun registerClass(clazz: Class<*>) {
            val ltc = object : LogThresholdCallback() {
                ...
                override fun shouldUpdate() {
                    ...
                    if (!done) Logger.error(this, "No log level field for " + c)
                }
            }
        ...
        @Synchronized
        @JvmStatic
        fun globalGetThresholdNew(): LogLevel = logger.getThresholdNew()
            ...
            return if (logger is LoggerHookChain) {
                ...
                if (oldLogger !is VoidLogger) {
                    if (oldLogger !is LoggerHook) {
                        throw IllegalStateException("The old logger is not a VoidLogger and is not a LoggerHook either!")
                    }
                }
                setupChain()
                if (oldLogger !is VoidLogger) {
