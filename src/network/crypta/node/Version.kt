...
public class Version {
     ...
     * Crypta Daemon
     */
    public static final String nodeName = "Cryptad";
     ...
     */
    public static final String nodeVersion = "@node_ver@";

    /**
     * The version for publicity purposes i.e. the version of the node that has
     * been released.
     */
    public static final String publicVersion = "@pub_ver@";
     ...
     */
    public static final String cvsRevision = "@git_rev@";
