...
public class BootstrapPushPullTest {
    ...
    public static void main(String[] args)
        ...
        try {
            ...
            RandomSource random =
                NodeStarter.globalTestInit(dir.getPath(), false, LogLevel.NORMAL, "", false);
            ...
            node = NodeStarter.createTestNode(DARKNET_PORT1, OPENNET_PORT1, dir.getPath(), false,
                                              Node.DEFAULT_MAX_HTL, 0, random, executor, 1000,
                                              5 * 1024 * 1024, true, true, true, true, true, true, true,
                                              12 * 1024, false, true, false, false, ipOverride);
            ...
            secondNode = NodeStarter.createTestNode(DARKNET_PORT2, OPENNET_PORT2, dir.getPath(), false,
                                                    Node.DEFAULT_MAX_HTL, 0, random, executor, 1000,
                                                    5 * 1024 * 1024, true, true, true, true, true, true,
                                                    true, 12 * 1024, false, true, false, false,
                                                    ipOverride);
            ...
            System.err.println("RESULT: Fetch took " + (endFetchTime - startFetchTime) + "ms (" +
