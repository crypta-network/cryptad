...
/**
 * This is the interface used to localize the Node. It just wraps a BaseL10n with correct parameters so
 * that this class can entierly be used using static methods, which is much more practical to use than
 * non-static methods.
 * <p>
 * Why doesn't that class extends BaseL10n ? Because it has to be static.
 * <p>
 * How to change the language ? Simply create a new NodeL1On object. You don't have to stock the created
 * object because you can access it using static methods.
 *
 * @author Artefact2
 */
public class NodeL10n {
    ...
    public NodeL10n(final LANGUAGE lang, File overrideDir) {
        NodeL10n.b = new BaseL10n("network/crypta/l10n/", "crypta.l10n.${lang}.properties",
                                  overrideDir.getPath() + File.separator +
                                  "crypta.l10n.${lang}.override.properties", lang);
    }
