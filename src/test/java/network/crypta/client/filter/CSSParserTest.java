...
import network.crypta.client.filter.*;
...
public class CSSParserTest {
	...
	private String filter(String css) throws IOException, URISyntaxException {
		...
		GenericReadFilterCallback
            cb = new GenericReadFilterCallback(new URI("/CHK@OR904t6ylZOwoobMJRmSn7HsPGefHSP7zAjoLyenSPw,x2EzszO4Kqot8akqmKYXJbkD-fSj6noOVGB-K2YisZ4,AAIC--8/1-works.html"), null, null, null);
