...
import network.crypta.node.MessageFragment;
import network.crypta.node.NPFPacket;
...
public class NPFPacketTest {
	...
	public void testPacketWithFragment() {
        ...
        assertArrayEquals(frag.fragmentData, new byte[]{(byte) 0x01, (byte) 0x23, (byte) 0x45,
	...
	public void testPacketWithFragments() {
		...
		assertEquals(0, frag.fragmentOffset);
		assertEquals(8, frag.messageLength);
        assertArrayEquals(frag.fragmentData, new byte[]{(byte) 0x01, (byte) 0x23, (byte) 0x45, (byte) 0x67, (byte) 0x89,
