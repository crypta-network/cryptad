...
public final class FCPPluginMessageEncodeDecodeTest {
  ...
  public void testEncodeDecode() throws MessageInvalidException, IOException, FSParseException {
    ...
    messages.add(
        FCPPluginMessage.constructErrorReply(
            FCPPluginMessage.construct(), "TestErrorCode", "Test errorMessage"));
    messages.add(
        FCPPluginMessage.constructErrorReply(FCPPluginMessage.construct(), "TestErrorCode", null));
    messages.add(FCPPluginMessage.constructErrorReply(FCPPluginMessage.construct(), null, null));
