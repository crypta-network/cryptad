  ...
  static {
    ...
    for (int i = 0; i <= (Character.MAX_VALUE - Character.MIN_VALUE); ++i) {
      ...
      if (characterValue >= Character.MIN_LOW_SURROGATE
          && characterValue <= Character.MAX_LOW_SURROGATE) ALL_CHARACTERS[i] = ' ';
      else if (characterValue >= Character.MIN_HIGH_SURROGATE
          && characterValue <= Character.MAX_HIGH_SURROGATE) ALL_CHARACTERS[i] = ' ';
      else ALL_CHARACTERS[i] = (char) characterValue;
    }
  }
