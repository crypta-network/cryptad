...
/**
 * FCP message sent from the node to the client which indicates that an error has occurred. These
 * are propagated so that resources can be freed on error more quickly than they would with just a
 * timeout.
 */
public class ProbeError extends FCPResponse {
   ...
   * @param code If error is UNKNOWN or UNRECOGNIZED_TYPE, can specify remote code. Not included
   *     otherwise.
