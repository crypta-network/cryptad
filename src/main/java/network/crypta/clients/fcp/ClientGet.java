...
public class ClientGet extends ClientRequest
  ...
  private void queueProgressMessageInner(
    ...
    if (persistence == Persistence.CONNECTION && handler == null) {
      if (origHandler != null) origHandler.send(msg);
      return;
    }
    if (handler != null) handler.handler.send(msg);
  ...
  public void sendPendingMessages(
    ...
    if (expectedHashes != null) {
      handler.handler.send(
          FCPMessage.withListRequestIdentifier(expectedHashes, listRequestIdentifier));
    }
  ...
  public void receive(ClientEvent ce, ClientContext context) {
    ...
    if (ce instanceof SplitfileProgressEvent event2) {
      ...
      synchronized (this) {
        progress = progressPending = new SimpleProgressMessage(identifier, global, event2);
      }
      if (client != null) {
        RequestStatusCache cache = client.getRequestStatusCache();
        if (cache != null) {
