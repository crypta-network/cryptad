 ...
 * codec, and FCP endpoint creation logic inside {@code network.crypta.clients.fcp.bridge}. Callers
 * in the top-level runtime package interact only with the narrower runtime-owned {@link
