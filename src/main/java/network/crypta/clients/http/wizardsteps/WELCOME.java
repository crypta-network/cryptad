...
public class WELCOME implements Step {
    ...
    public void getStep(HTTPRequest request, PageHelper helper) {
        ...
        if (fProxyJavascriptEnabled) {
            contentNode.addChild("script", "type", "text/javascript").addChild("%",
                                                                               "window.location" +
																			   ".replace(\"" +
        ...
        HTMLNode dropDown =
            ConfigToadlet.addComboBox(language.getValueDisplayString(), l10nCallback, language.getName(),
                                      false);
    ...
    private void addSecurityTableCell(
        ...
        secForm.addChild("input", new String[]{"type", "name", "value",},
                         new String[]{"hidden", "incognito", String.valueOf(incognito),});
        secForm.addChild("input", new String[]{"type", "name", "value"},
                         new String[]{"submit", "preset" + preset,
                             WizardL10n.l10n("presetChoose" + preset)});
    }
