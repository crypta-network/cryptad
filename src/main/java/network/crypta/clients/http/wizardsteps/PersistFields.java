...
/**
 * Handles fields that should be persisted, making them available through public properties. Able to
 * parse these fields from an HTTPRequest.
 */
public class PersistFields {
  ...
  /**
   * @param request Parsed for persistence fields, checking parameters (GET) first, then parts
   *     (POST).
   */
