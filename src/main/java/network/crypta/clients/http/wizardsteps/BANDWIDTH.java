...
/**
 * Asks the user whether their connection has a monthly cap to inform how to prompt for bandwidth
 * limits.
 */
public class BANDWIDTH implements Step {
  ...
  public String postStep(HTTPRequest request) {
    ...
    /*else if (request.isPartSet("no"))*/ return FirstTimeWizardToadlet.WIZARD_STEP.BANDWIDTH_RATE
        .name();
