...
public abstract class BaseUpdateableElement extends HTMLNode {
  ...
  /**
   * Returns the id, that identifies the element. It can depend on the request, but it might not use
   * it. It should not change e.g. when we follow a redirect as it is used in internal structures to
