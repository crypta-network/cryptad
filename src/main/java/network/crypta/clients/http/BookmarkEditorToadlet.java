    ...
    if (!req.getParam("action").isEmpty() && !originalBookmark.isEmpty()) {
      ...
      if (bookmark == null) {
                  ...
                  NodeL10n.getBase()
                      .getString(
                          "BookmarkEditorToadlet.edit"
                              ...
                              + "Title");
              case "addItem" ->
                  NodeL10n.getBase().getString("BookmarkEditorToadlet.addNewBookmark");
        ...
        if (("edit".equals(action) && bookmark instanceof BookmarkItem)
          ...
          if (core.getNode().getDarknetConnections().length > 0
    ...
    try {
      ...
      if (req.isPartSet("confirmdelete")) {
        ...
        Bookmark targetBookmark =
            bookmarkManager.getBookmarkByPath(bookmarkManager.parentPath(bookmarkPath) + name);
