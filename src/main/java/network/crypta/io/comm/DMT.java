...
public class DMT {
  ...
  public static final MessageType allSent =
      new MessageType("allSent", PRIORITY_BULK_DATA) {
        {
          addField(UID, Long.class);
        }
      };
  ...
  public static final MessageType FNPRejectedLoop =
      new MessageType("FNPRejectLoop", PRIORITY_HIGH) {
        {
          addField(UID, Long.class);
        }
      };
  ...
  public static final MessageType FNPAccepted =
      new MessageType("FNPAccepted", PRIORITY_HIGH) {
        {
          addField(UID, Long.class);
        }
      };
  ...
  public static final MessageType FNPDataInsert =
      new MessageType("FNPDataInsert", PRIORITY_HIGH) {
        {
          addField(UID, Long.class);
          addField(BLOCK_HEADERS, ShortBuffer.class);
        }
  ...
  public static final MessageType FNPSSKAccepted =
      new MessageType("FNPSSKAccepted", PRIORITY_HIGH) {
        {
          addField(UID, Long.class);
          addField(NEED_PUB_KEY, Boolean.class);
        }
  ...
  public static final MessageType FNPOfferKey =
      new MessageType("FNPOfferKey", PRIORITY_LOW) {
        {
  ...
  public static final MessageType FNPPing =
      new MessageType("FNPPing", PRIORITY_HIGH) {
        {
  ...
  public static final MessageType FNPPong =
      new MessageType("FNPPong", PRIORITY_HIGH) {
        {
          addField(PING_SEQNO, Integer.class);
        }
      };
  ...
  public static final MessageType ProbeRequest =
      new MessageType("ProbeRequest", PRIORITY_HIGH) {
        {
  ...
  public static final MessageType ProbeError =
      new MessageType("ProbeError", PRIORITY_HIGH) {
        {
          addField(UID, Long.class);
          addField(TYPE, Byte.class);
        }
  ...
  public static final MessageType ProbeRefused =
      new MessageType("ProbeRefused", PRIORITY_HIGH) {
        {
  ...
  public static final MessageType ProbeBandwidth =
      new MessageType("ProbeBandwidth", PRIORITY_HIGH) {
        {
          addField(UID, Long.class);
  ...
  public static final MessageType ProbeBuild =
      new MessageType("ProbeBuild", PRIORITY_HIGH) {
        {
          addField(UID, Long.class);
  ...
  public static final MessageType ProbeLocation =
      new MessageType("ProbeLocation", PRIORITY_HIGH) {
        {
          addField(UID, Long.class);
  ...
  public static final MessageType ProbeStoreSize =
      new MessageType("ProbeStoreSize", PRIORITY_HIGH) {
        {
          addField(UID, Long.class);
  ...
  public static final MessageType ProbeUptime =
      new MessageType("ProbeUptime", PRIORITY_HIGH) {
        {
          addField(UID, Long.class);
  ...
  public static final MessageType FNPSwapRequest =
      new MessageType("FNPSwapRequest", PRIORITY_HIGH) {
        {
          addField(UID, Long.class);
  ...
  public static final MessageType FNPSwapReply =
      new MessageType("FNPSwapReply", PRIORITY_HIGH) {
        {
          addField(UID, Long.class);
          addField(HASH, ShortBuffer.class);
        }
  ...
  public static final MessageType FNPSwapCommit =
      new MessageType("FNPSwapCommit", PRIORITY_HIGH) {
        {
          addField(UID, Long.class);
          addField(DATA, ShortBuffer.class);
        }
  ...
  public static final MessageType FNPRoutedPing =
      new MessageType("FNPRoutedPing", PRIORITY_LOW) {
        {
  ...
  public static final MessageType FNPRoutedPong =
      new MessageType("FNPRoutedPong", PRIORITY_LOW) {
        {
          addField(UID, Long.class);
          addField(COUNTER, Integer.class);
        }
  ...
  public static final MessageType FNPTime =
      new MessageType("FNPTime", PRIORITY_HIGH) {
        {
  ...
  public static final MessageType FNPUptime =
      new MessageType("FNPUptime", PRIORITY_LOW) {
        {
  ...
  public static final MessageType FNPVisibility =
      new MessageType("FNPVisibility", PRIORITY_HIGH) {
        {
  ...
  public static final MessageType FNPSentPackets =
      new MessageType("FNPSentPackets", PRIORITY_HIGH) {
        {
  ...
  public static final MessageType FNPVoid =
      new MessageType("FNPVoid", PRIORITY_LOW, false, true) {
        {
        }
      };
  ...
  public static final MessageType FNPDisconnect =
      new MessageType("FNPDisconnect", PRIORITY_HIGH) {
        {
