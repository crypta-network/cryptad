...
public interface ByteCounter {
  ...
  /**
   * Sent payload - only include the number of bytes of actual payload i.e. data from the user's
   * point of view, as opposed to overhead.
   *
   * <p>IMPORTANT: This will also be reported to sentBytes()! DO NOT ADD the total from sentBytes()
