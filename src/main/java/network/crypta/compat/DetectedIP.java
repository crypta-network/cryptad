...
public class DetectedIP {
  public static final int FULL_INTERNET = 0;
  public static final int FULL_CONE_NAT = 1;
  public static final int RESTRICTED_CONE_NAT = 2;
  public static final int PORT_RESTRICTED_NAT = 3;
  public static final int SYMMETRIC_NAT = 4;
  public static final int SYMMETRIC_UDP_FIREWALL = 5;
  public static final int NO_UDP = 6;
