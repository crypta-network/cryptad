...
public class CurrentTimeUTC {
   ...
   * @deprecated use {@link LocalDate#getMonthValue() LocalDate.now(ZoneOffset.UTC).getMonthValue()
   *     - 1}
   */
  @Deprecated
  public static int getMonth() {
    // Previously, this method used java.util.GregorianCalendar and Calendar.MONTH, which is
    // zero-based.
