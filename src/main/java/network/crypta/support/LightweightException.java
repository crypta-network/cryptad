 ...
 *
 * <p>This kind of exception does not provide stack traces. Subclasses can override this behaviour
...
public class LightweightException extends Exception {
  ...
  /**
   * Allows subclasses to override the default lack of a stack trace for debugging purposes. The
   * default implementation in {@link LightweightException} always returns {@code false}.
   *
