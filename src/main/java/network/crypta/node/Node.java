...
import network.crypta.node.useralerts.*;
...
import network.crypta.support.api.*;
...
public class Node implements TimeSkewDetectorCallback {
    ...
    Node(PersistentConfig config, RandomSource r, RandomSource weakRandom, LoggingConfigHandler lc, NodeStarter ns, Executor executor) throws NodeInitException {
        ...
        nodeConfig.register("cachingFreenetStoreMaxSize", defaultCacheSize, sortOrder++, true, false, "Node.cachingCryptaStoreMaxSize", "Node.cachingCryptaStoreMaxSizeLong",
                new LongCallback() {
                    @Override
                    public Long get() {
                        synchronized (Node.this) {
        ...
        nodeConfig.register("cachingFreenetStorePeriod", "300k", sortOrder++, true, false, "Node.cachingCryptaStorePeriod", "Node.cachingCryptaStorePeriod",
                new LongCallback() {
                    @Override
                    public Long get() {
                        synchronized (Node.this) {
