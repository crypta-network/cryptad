    ...
    private boolean loadConfigFile(byte[] masterKey) throws IOException {
        ...
        if (!configFile.exists()) {
            ...
            if (masterKey != null) {
                ...
                if (logDEBUG)
                    Logger.debug(this, "Encrypting with " + HexUtil.bytesToHex(newsalt) + " from " +
            ...
            try {
                ...
                try (RandomAccessFile raf = new RandomAccessFile(configFile, "r")) {
                    ...
                    if (masterKey != null) {
                        ...
                        if (logDEBUG)
                            Logger.debug(this, "Encrypting (new) with " + HexUtil.bytesToHex(salt) + " from " +
                                    HexUtil.bytesToHex(diskSalt));
                    }
    ...
    private final class CleanerStatusUserAlert extends AbstractUserAlert {
        ...
        public String getShortText() {
            if (cleaner.isResizing)
                return NodeL10n.getBase().getString("SaltedHashCryptaStore.shortResizeProgress", //
                ...
                return NodeL10n.getBase().getString("SaltedHashCryptaStore.shortRebuildProgress" + (slotFilter.isNew() ? "New" : ""),
                        new String[]{"name", "processed", "total"},//
                        new String[]{name, String.valueOf(cleaner.entriesTotal - cleaner.entriesLeft),
                                String.valueOf(cleaner.entriesTotal)});
        }
        ...
        public String getText() {
            if (cleaner.isResizing)
                return NodeL10n.getBase().getString("SaltedHashCryptaStore.longResizeProgress", //
                        new String[]{"name", "processed", "total"},//
                        new String[]{name, String.valueOf(cleaner.entriesTotal - cleaner.entriesLeft),
                                String.valueOf(cleaner.entriesTotal)});
            else
                return NodeL10n.getBase().getString("SaltedHashCryptaStore.longRebuildProgress" + (slotFilter.isNew() ? "New" : ""),
                        new String[]{"name", "processed", "total"},
                        new String[]{name, String.valueOf(cleaner.entriesTotal - cleaner.entriesLeft),
                                String.valueOf(cleaner.entriesTotal)});
        }
        ...
        public String getTitle() {
            return NodeL10n.getBase().getString("SaltedHashCryptaStore.cleanerAlertTitle", //
                    new String[]{"name"}, //
                    new String[]{name});
        }
