 ...
 *
 * <p>Indicates: - Whether there is no UDP connectivity at all. - Whether there is full inbound IP
 * connectivity. - A list of detected public IPs.
 */
public class DetectedIP {
  ...
  /**
   * Symmetric NAT. Uses a separate port number for each IP+port ! Not much hope for symmetric to
   * symmetric...
   */
