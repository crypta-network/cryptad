...
/**
 * Interface that has to be implemented for plugins that wants to use the node's localization system
 * (recommended).
 *
 * <p>Those methods are called by the node when plugin l10n data are needed, ex. to automate things
 * in the translation page.
 *
 * @author Artefact2
 */
