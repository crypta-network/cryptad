...
/**
 * This class allows you to easily compute rate for various events. A weighted floating average is
 * used and all parameters can be tweaked to fine tune your rate calculations.
 *
...
public class RateCalculator {
   ...
   * @param historyWeight The multipler used to determine the relevence of older intervals.
   *     <p>Using a small historySize and/or a low historyWeight will cause the rate to fit tightly
   *     against the current rate. Using higher values allows the rate to be much smoother. If this
   *     is being used for direct UI it is usually nice to have a frequently updated smooth rate.
   */
  ...
  /**
   * Pauses the RateCalculator. The RateCalculator will be resumed with the next call to resume().
   * It is not advised to update events during the paused period.
   */
  ...
  /**
   * This is the preferred way to update the number of events for rate calculation, it will simply
   * use the time of the call to keep track of when the events occured.
   */
  ...
  /**
   * If you wish to specify exactly the time at which the events occured you can use this method. It
   * is very important that subsequent calls to update have eventTime's monotonically increasing.
   */
  ...
  /**
   * If you are specifying a time with update(long time) then you must specify the time at which you
   * wish to view the rate for, this time must be greater than the last time that was passed to the
   * update call. This method DOES NOT allow you to see what the rate was at during a previous
   * interval.
   */
