...
public class TimedSoftHashMap extends HashMap {
  ...
  /**
   * This class is only necessary for the containsValue calls, as the keys in the TimedSoftHashMap
   * should not be SoftReferences and there for should already have equals() and hashCode() that
   * works.
   */
