...
public class LazyRenameRAF extends FilterRAF {
  ...
  /**
   * If the current location and the newFile are different, it is guarenteed that the file will be
   * moved to some new location, even if it isn't the final destination. This is to allow the safe
   * setting of deleteOnExit for locations that are intended to be temporary.
   */
