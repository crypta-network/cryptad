...
public class Bitcollider {
  ...
  public static final String ERROR_TEMPFILEERR =
      "Cannot create a temorary file for the bitprint submission.";
  ...
  public Submission generateSubmission(List fileList, String asExt, boolean autoSubmit) {
