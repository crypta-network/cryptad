...
public abstract class AbstractCurveFitter implements EstimationProblem, Serializable {
   ...
   * Perform the fitting.
   *
   * <p>This method compute the coefficients of the curve that best fit the sample of weighted pairs
   * previously given through calls to the {@link #addWeightedPair addWeightedPair} method.
   *
  ...
  /**
   * Get the unbound parameters of the problem. For a curve fitting, none of the function
   * coefficient is bound.
   *
   ...
   *
   * <p>This method is provided as a utility for derived classes. As an example, the {@link
   * HarmonicFitter} class needs it in order to compute a first guess of the coefficients to
