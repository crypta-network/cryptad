 ...
 * a class implementing this interface to allow the optimization algorithm to stop its search
...
public interface ConvergenceChecker {
   ...
   *
   * @param simplex ordered simplex (all points in the simplex have been eavluated and are sorted
   *     from lowest to largest cost)
