...
public class LowerTriangularMatrix extends SquareMatrix {
  ...
  /**
   * Simple constructor. This constructor builds a lower triangular matrix of specified order, all
  ...
  /**
   * Substract a matrix from the instance. This method substract a matrix from the instance. It does
   * modify the instance.
   *
