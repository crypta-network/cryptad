...
public class DiagonalMatrix extends SquareMatrix {
  ...
  /**
   * Simple constructor. This constructor builds a diagonal matrix of specified order, all elements
   * on the diagonal being ones (so this is an identity matrix).
   *
  ...
  /**
   * Simple constructor. This constructor builds a diagonal matrix of specified order and set all
   * diagonal elements to the same value.
   *
   * @param order order of the matrix
