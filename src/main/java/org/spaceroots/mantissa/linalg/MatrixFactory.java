 ...
 *
 * <p>This class is devoted to building the right type of matrix according to the structure of the
 * non null elements.
 *
 * <p>This is a utility class, no instance of this class should be built, so the constructor is
...
public class MatrixFactory {
  ...
  /**
   * Build a matrix of the right subtype. Build the right subtype of matrix according to the
   * structure of the non null elements of the instance. Note that the information provided does not
   * allow to build instances of the {@link SymetricalMatrix} class. When the data corresponding to
   * a symetrical matrix is given, this method can only build an instance of the {@link
   * GeneralSquareMatrix} class.
   *
