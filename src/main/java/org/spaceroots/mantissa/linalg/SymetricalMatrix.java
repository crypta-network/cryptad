...
public class SymetricalMatrix extends GeneralSquareMatrix {
  ...
  /**
   * Simple constructor. This constructor builds a symetrical matrix of specified order, all
  ...
  /**
   * Set a matrix element. On symetrical matrices, setting separately elements outside of the
   * diagonal is forbidden, so this method throws an ArrayIndexOutOfBoundsException in this case.
   * The {@link #setElementAndSymetricalElement} can be used to set both elements simultaneously.
   *
  ...
  public void setElement(int i, int j, double value) {
    if (i != j) {
      throw new ArrayIndexOutOfBoundsException(
          "cannot separately set" + " elements out of diagonal" + " in a symetrical matrix");
    }
   ...
   *
   * @param i row index of first element (column index of second element), from 0 to order - 1
   * @param j column index of first element (row index of second element), from 0 to order - 1
  ...
  /**
   * Add a matrix to the instance. This method adds a matrix to the instance. It does modify the
   * instance.
   *
  ...
  /**
   * Add the symetrical matrix resulting from the product w.A.At to the instance. This method can be
   * used to build progressively the matrices of least square problems. The instance is modified.
   *
   * @param w multiplicative factor (weight)
   * @param a base vector used to compute the symetrical contribution
   * @exception IllegalArgumentException if there is a dimension mismatch
