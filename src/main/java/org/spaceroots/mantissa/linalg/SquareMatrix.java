 ...
 *
 * <p>This class is the base class of all square matrix implementations. It extends the {@link
 * Matrix} class with methods specific to square matrices.
 *
...
public abstract class SquareMatrix extends Matrix {
   ...
   *
   * @param epsilon threshold on matrix elements below which the matrix is considered singular (this
   *     is used by the derived classes that use a factorization to compute the determinant)
   ...
   * Invert the instance.
   *
   * @param epsilon threshold on matrix elements below which the matrix is considered singular
