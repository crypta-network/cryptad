 ...
 *
 * <p>Legendre polynomials can be defined by the following recurrence relations:
 *
 * <pre>
 *        P<sub>0</sub>(X)   = 1
 *        P<sub>1</sub>(X)   = X
...
public class Legendre extends OrthogonalPolynomial {
  ...
  /** Simple constructor. Build a degree 0 Legendre polynomial */
  public Legendre() {
    super(0, generator);
  }

  /**
   * Simple constructor. Build a degree d Legendre polynomial
   *
