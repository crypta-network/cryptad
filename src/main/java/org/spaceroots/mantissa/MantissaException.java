 ...
 *
 * <p>When the mantissa classes throw exceptions that are specific to the package, these exceptions
 * are always subclasses of MantissaException. When exceptions that are already covered by the
 * standard java API should be thrown, like ArrayIndexOutOfBoundsException or
 * IllegalArgumentException, these standard exceptions are thrown rather than the mantissa specific
 * ones.
 *
