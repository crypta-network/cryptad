...
DEB_ARCH="amd64 i386"
DEB_CANDIDATES=""
for version in 21 18 17 16 15 14 13 12 11 10 9; do DEB_CANDIDATES="$DEB_CANDIDATES /usr/lib/jvm/java-$version-openjdk/jre/bin/java"; for arch in $DEB_ARCH; do DEB_CANDIDATES="$DEB_CANDIDATES /usr/lib/jvm/java-$version-openjdk-$arch/jre/bin/java";done;done
